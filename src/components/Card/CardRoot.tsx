  ...
  return (
    <button
      ...
      className="
        ...
        [&_h3]:after:hover:animate-[stretch_300ms_ease-in-out_forwards_150ms]  
        
        
        [&_h3]:focus:left-0 [&_h3]:focus:top-0 [&_h3]:focus:w-[8.5rem]
        [&_h3]:focus:translate-x-0 [&_h3]:focus:translate-y-0
        [&_h3]:after:focus:animate-[stretch_300ms_ease-in-out_forwards_150ms]  
        
        [&_p]:hover:h-fit [&_p]:hover:w-full 
        [&_p]:hover:animate-[showUp_300ms_ease-in-out_forwards_150ms]
        [&_p]:focus:h-fit [&_p]:focus:w-full 
        [&_p]:focus:animate-[showUp_300ms_ease-in-out_forwards_150ms]
      "
    >
      {children}
    </button>
